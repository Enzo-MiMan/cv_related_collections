...
class Encoder(object):
    ...
    def encode(self, bboxes_in, labels_in, criteria=0.5):
        ...
        # 将相应default box匹配最大IOU的GT索引进行替换， 保证每个 bbox 都被 dbox 匹配到
...
class DefaultBoxes(object):
    def __init__(self, fig_size, feat_size, steps, scales, aspect_ratios, scale_xy=0.1, scale_wh=0.2):
        ...
        self.aspect_ratios = aspect_ratios  # 每个预测特征层上预测的default box的ratios: [[2], [2, 3], [2, 3], [2, 3], [2], [2]]

        # According to https://github.com/weiliu89/caffe
        # Calculation method slightly different from paper
        self.steps = steps    # 每个特征层上的一个cell在原图上的跨度: [8, 16, 32, 64, 100, 300]
...
def dboxes300_coco():
    ...
    dboxes = DefaultBoxes(figsize, feat_size, steps, scales, aspect_ratios)   # default box 的shape 为 [8732， 4]
    return dboxes
